...
We have used heap snapshots in Google Chrome to get a picture of how much memory the streamer is using,
when idle and when we add songs to it.
In \ref{fig:memUsage} we have made an experiment,
...
so storing 1 MB of data alway takes around 6 MB of data in memory for all the songs.
