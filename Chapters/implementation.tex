...
Traditional browser cookies can store up to 4KB of data, not even enough to save a single song, to store a song in cookies, we would need to create thousands of cookies, and store parts of a song in each one, this seemed like a difficult and inelegant solution.
