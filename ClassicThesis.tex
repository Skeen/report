...
\input{Chapters/WebSockets.tex}
%% TODO: Move this about
\input{Chapters/WebTorrent.tex}
%% TODO: Move this about, but after WebTorrent
\input{Chapters/Tracker.tex}
...
\chapter{Showcase}
Our project can be seen at \footnote{\url{https://youtu.be/X0lIZpOK1Qk}}. It is a description of where the music streamer can be accessed (for more information see the manual \ref{part:manual} for more information) and how to use it.
...
\input{Chapters/ProjectProposal}
